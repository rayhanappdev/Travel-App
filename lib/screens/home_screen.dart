...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<TravelSpot> allSpots = [
    TravelSpot(
      ...
      bookingUrl: "https://www.shoboj.com",
    ),
    TravelSpot(
      name: 'সেন্ট মার্টিন',
      ...
      bookingUrl: 'https://www.travelbd.com/saint-martin',
    ),
    TravelSpot(
      name: 'সিলেট রাতারগুল',
      category: "জলাবন",
      ...
      bookingUrl: 'https://www.travelbd.com/ratargul',
    ),
    TravelSpot(
      name: 'সাজেক ভ্যালি',
      category: "পাহাড়",
      ...
      bookingUrl: 'https://www.travelbd.com/sajek',
    ),
    TravelSpot(
      name: 'জাফলং',
      ...
      bookingUrl: 'https://www.travelbd.com/jaflong',
    ),
    TravelSpot(
      ...
      bookingUrl: "https://www.travelbd.com/nilgiri",
    ),
    ...
    TravelSpot(
      ...
      bookingUrl: "https://www.travelbd.com/coxsbazar",
    ),
    ...
    TravelSpot(
      ...
      bookingUrl: "https://www.travelbd.com/kaptai",
    ),
    ...
    TravelSpot(
      ...
      bookingUrl: "https://www.travelbd.com/bisnakandi",
    ),
    ...
    TravelSpot(
      ...
      bookingUrl: "https://www.travelbd.com/kuakata",
    ),
    ...
    TravelSpot(
      ...
      bookingUrl: "https://www.travelbd.com/nikli",
    ),
  ];
